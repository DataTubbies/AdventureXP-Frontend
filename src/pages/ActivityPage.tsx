...
export default function ActivityPage() {
  ...
  const [activityEvents, setActivityEvents] = useState<ApiEventActivity[]>([]);
  useEffect(() => {
    getActivityEventsByActivityId(String(id)).then((res) => {
      // TODO: Check if res is auth error - or array!
              ...
              <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
                ...
                <div className="w-full sm:w-1/2 mb-4 px-2 ">
                  <div className="h-full py-4 px-6 border border-green-500 border-t-0 border-l-0 rounded-br-xl">
                    ...
                    <p className="text-sm">
                      Minimumsalderen for at deltage i denne aktivitet er fastsat til {activity.ageLimit} år. Denne aldersgrænse er fastlagt med henblik på at sikre, at deltagere har en vis grad af
                      fysisk og mental modenhed, der kræves for at håndtere og nyde aktiviteten sikkert. Yngre børn kan have begrænsede motoriske færdigheder og forståelse for sikkerhedsprocedurer,
                      hvilket kan øge risikoen for ulykker eller skader.
                    </p>
                  </div>
                </div>
