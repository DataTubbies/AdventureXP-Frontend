      ...
      <nav className="bg-black-950  border-gray-200 text-black-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            {!auth.isLoggedIn() && (
              <div className="list-none font-medium p-4">
                <NavItem pathLink="/signup" itemName="Opret profil" />
              </div>
            )}
            <button type="button" className="text-white bg-astronaut-blue-900 hover:bg-astronaut-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center">
              <AuthStatus />
            </button>
          </div>
