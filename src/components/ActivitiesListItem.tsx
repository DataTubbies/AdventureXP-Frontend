    ...
    <>
      <article className="grid grid-cols-5 shadow-[0_3px_10px_rgb(0,0,0,0.2)] mb-10 mx-32 rounded-lg">
        <img
          ...
          src="https://www.pragpolterabend.dk/obj/files/9/sys_media_6140.jpg"
          alt="Activity"
          width="195"
          height="130"
        />
        <table className="col-span-4">
          <td>
            ...
            <tr className="text-lg font-normal italic col-span-4 mb-10">
              Aldersgrænse: {activity.ageLimit} år
            </tr>
          </td>
